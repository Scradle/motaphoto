<div class="img-hoverbox" 
    ...
    <img class="img-icon-fullscreen" src="<?php echo get_template_directory_uri() . './assets/images/Icon_fullscreen.png'; ?> " alt="icone de la lightbox"> <!-- Pour appeler la lightbox -->
    <a href="<?php echo esc_url(get_permalink()); ?>"><img class="img-icon-eye" src="<?php echo get_template_directory_uri() . './assets/images/Icon_eye.png'; ?> " alt="icone de la hoverbox"></a>  <!-- Pour aller sur la page de la photo --> 
